...
<head>
    ...
    <title>Register Account | Wirepick Direct</title>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" class="template-customizer-core-css" href="<c:url value="/assets/vendor/css/core.css" />"/>
    <link rel="stylesheet" class="template-customizer-theme-css" href="<c:url value="/assets/vendor/css/theme-default.css" />"/>
    ...
    <!-- Helpers -->
    <script href="<c:url value="/assets/vendor/js/helpers.js" />"/></script>
    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Config:  Mandatory theme config file contain global vars & default theme options, Set your preferred theme option in this file.  -->
    <script href="<c:url value="/assets/js/config.js" />"/></script>
</head>
                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                          <g id="Icon" transform="translate(27.000000, 15.000000)">
                            ...
                            <span class="app-brand-text demo text-body fw-bolder">Wirepick</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <h4 class="mb-2">Welcome to Wirepick Direct! 👋</h4>
                    <p class="mb-4">Enter your details below to register</p>

                    <form id="registerForm" class="mb-3" action="index.html" method="POST">
                        <div class="mb-3">
                        ...
                        <button type="button" id="registerBtn" class="btn btn-primary d-grid w-100">Sign up</button>
                    </form>
