...
<head>
    ...
    <title>Login | Wirepick Direct</title>
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <span class="app-brand-logo demo">
                    ...
                    <p class="mb-4">Enter your details below to sign in</p>

                    <form id="loginForm" class="mb-3" method="post" autocomplete="off">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <button class="btn btn-primary d-grid w-100" type="button" id="loginBtn">Sign in</button>
                        </div>
                    </form>
