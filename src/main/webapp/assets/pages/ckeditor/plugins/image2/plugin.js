...
( function() {
	...
	function widgetDef( editor ) {
		...
		return {
			...
			init: function() {
				...
				// Pass the workflowReference to this widget to the dialog.
	...
	CKEDITOR.plugins.image2 = {
		stateShifter: function( editor ) {
			...
			// Wraps <img/> -> <a><img/></a>.
			// Returns workflowReference to <a>.
			//
			...
			// Returns the workflowReference to <img/>
			//
		 ...
		 *
		 * **Note:** If a custom getter is used, a data modals format it produces
		 * must be compatible with {@link CKEDITOR.plugins.link#getLinkAttributes}.
		 *
		 * **Note:** A custom getter must understand the data modals format produced by
		 ...
		 * in the absence of the Link plugin.
		 *
		 * **Note:** If a custom parser is used, a data modals format produced by the parser
		 * must be compatible with {@link #getLinkAttributesGetter}.
		 *
		 * **Note:** If a custom parser is used, it should be compatible with the
		 * {@link CKEDITOR.plugins.link#parseLinkAttributes} data modals format. Otherwise the
		 * Link plugin dialog may not be populated correctly with parsed data. However
		 * as long as Enhanced Image is **not** used with the Link plugin dialog, any custom data modals
