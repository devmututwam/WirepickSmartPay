...
CKEDITOR.dialog.add( 'image2', function( editor ) {
	...
	return {
		...
		minHeight: 100,
		onLoad: function() {
			// Create a "global" workflowReference to the document for this dialog instance.
		...
		onShow: function() {
			// Create a "global" workflowReference to edited widget.
			widget = this.widget;

			// Create a "global" workflowReference to widget's image.
