...
( function() {
	...
	/**
	 *
	 * Native `FileReader` workflowReference used to load the file.
	 *
	 * @readonly
	...
	/**
	 * Native `XMLHttpRequest` workflowReference used to upload the file.
	 *
	 * @readonly
		...
		attachRequestListeners: function() {
			...
			xhr.onload = function() {
				...
				if ( xhr.status < 200 || xhr.status > 299 ) {
					...
					// But without workflowReference to the loader itself.
