...
Y.Resize = Y.extend(
	...
	Y.Base,
	{
		...
		/**
		 * Store DD.Delegate workflowReference for the respective Resize instance.
		 *
		 * @property delegate
		 * @default null
		 * @type Object
		 ...
		 * the passed node. For more workflowReference see
		...
		_resizeStart: function(event) {
			...
			// create an originalInfo information for workflowReference
