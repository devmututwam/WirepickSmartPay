    ...
    ATTRS: {
        ...
        **/
        ...
        @param {Object} data Data relevant to the rendering of this cell
            ...
            @param {String} data.headers TH ids to workflowReference in the cell's
                            "headers" attribute
...
Y.extend(Column, Y.Widget, {
    ...
    */
    ...
    /**
     * The Node workflowReference to the associated TH element.
     *
     * @property thNode
     * @type {Node}
     */
    ...
    /*TODO
     * The Node workflowReference to the associated liner element.
     *
    ...
    initializer: function() {
        ...
        function parseColumns(depth, currentDefinitions, parent) {
            ...
            for(; i<len; ++i) {
                ...
                // Cross-workflowReference Column ID back to the original object literal definition
