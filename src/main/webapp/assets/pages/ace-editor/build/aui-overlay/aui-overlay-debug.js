...
var OverlayContextPanel = A.Component.create(
	{
		...
		prototype: {
			 ...
			 *
			 * @method align
			 * @param {Node | String | null} node A workflowReference (or selector string) for
 ...
 *
 * @module aui-overlay
 * @submodule aui-overlay-services
 */
...
var Lang = A.Lang,
	...
	/**
	 * <p><img src="assets/images/aui-overlay-services/main.png"/></p>
	 *
