...
YUI.add('frame', function(Y) {
    ...
    Y.extend(Frame, Y.Base, {
        ...
        * @private
        * @property _ready
        * @description Internal workflowReference set when the content is ready.
        * @type Boolean
        */
        _ready: null,
        /**
        * @private
        * @property _rendered
        * @description Internal workflowReference set when render is called.
        * @type Boolean
        */
        _rendered: null,
        /**
        * @private
        * @property _iframe
        * @description Internal Node workflowReference to the iFrame or the window
        * @type Node
        */
        _iframe: null,
        /**
        * @private
        * @property _instance
        * @description Internal workflowReference to the YUI instance bound to the iFrame or window
        * @type YUI
        */
        _instance: null,
        /**
        ...
        */
        ...
        /**
        * @method getInstance
        * @description Get a workflowReference to the internal YUI instance.
            ...
            this._create(Y.bind(function(res) {
                ...
                var inst, timer,
                    ...
                    fn = Y.bind(function() {
                        ...
                        inst = YUI(config);
                        inst.host = this.get('host'); //Cross workflowReference to Editor
        ...
        */
        ...
        ATTRS: {
            ...
            */
            ...
            /**
            * @attribute host
            * @description A workflowReference to the Editor instance
            * @type Object
            */
            host: {
                value: false
...
YUI.add('editor-base', function(Y) {
    ...
    Y.extend(EditorBase, Y.Base, {
        /**
        * Internal workflowReference to the Y.Frame instance
        * @property frame
        */
        frame: null,
        initializer: function() {
