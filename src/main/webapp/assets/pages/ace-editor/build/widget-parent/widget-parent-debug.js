...
function Parent(config) {
    ...
    * 'child' property that returns a workflowReference to the child Widget, as well
    * as an 'index' property that returns a workflowReference to the index specified
    ...
    * 'child' property that returns a workflowReference to the child Widget, as well
    * as an 'index' property that returns a workflowReference child's ordinal position.
    * <p>
    * Subscribers to the "on" moment of this event, will be notified 
