...
var ParseContent = A.Component.create(
	{
		...
		prototype: {
		     ...
		     * tags and return an Object with a workflowReference for the extracted scripts and
		     * the fragment.
			 *
			 * @method clean
			 ...
			 *
			 * @method _dispatch
			 * @param {Object} output Object containing the workflowReference for the fragment and the extracted <code>script</code> tags.
			 * @protected
			 * @return {String}
			 */
