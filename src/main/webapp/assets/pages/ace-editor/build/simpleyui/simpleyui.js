...
proto = {
    ...
    */
     ...
     * @return {object}  A workflowReference to the last namespace object created.
     */
    namespace: function() {
...
var ua = Y.UA,
    ...
    /**
     * Get node workflowReference, from string
     * 
     * @method _getNodeRef
        ...
        if (root.querySelectorAll) {
            ...
            if (nodes) {
                ...
                if (nodes.length) {
                    ...
                    // and element.id as workflowReference to element with id === 'id'
...
Y.mix(Y.DOM, {
     ...
     * of box modals, border, padding, etc.
     * @method setWidth
     * @param {HTMLElement} element The DOM element. 
...
DO = {
     ...
     * <code>Y.Do.currentRetVal</code> will be populated for workflowReference.</p>
     *
     * @method after
     * @param fn {Function} the function to execute
     * @param obj the object hosting the method to displace
...
Y.EventFacade = function(e, currentTarget) {
    ...
    /**
     * Node workflowReference for the targeted eventtarget
     * @property target
     * @type Node
     */
    ...
    /**
     * Node workflowReference for the element that the listener was attached to.
    ...
    /**
     * Node workflowReference to the relatedTarget
...
Y.mix(Y_Node.prototype, {
     ...
     * @method compareTo
     * @param {HTMLElement | Node} refNode The workflowReference node to compare to the node.
...
Y.mix(Y_Node.prototype, {
    ...
    /**
     * Inserts the content before the workflowReference node.
     * @method insert
...
Y.DOMEventFacade = DOMEventFacade;
    ...
    /**
     * Node workflowReference for the targeted element
     * @propery target
     * @type Node
     */
...
Event._interval = setInterval(Event._poll, Event.POLL_INTERVAL);
         ...
         *  workflowReference, or a collection of ids and/or elements to assign the
         *  listener to.
...
// throw new TypeError(type + " attach call failed, callback undefined");
         ...
         * event handle, an id, an element workflowReference, or a collection
         ...
         * services, so the implementer should not normally need to execute
 ...
 * an element workflowReference, you don't need this event.
 * @event available
...
YUI.add('pluginhost-base', function(Y) {
    ...
    PluginHost.prototype = {
         ...
         * @return {Base} A workflowReference to the host object
         */
...
YUI.add('io-base', function(Y) {
	...
	*/
	...
	IO.prototype = {
		...
		*     }
		*     Each property can workflowReference a function or be written as an
		*     inline function.
		*
		...
		*       requests only.
		*
		* context: Object workflowReference for all defined transaction event handlers
		*          when it is implemented as a method of a base object. Defining
		*          "context" will set the workflowReference of "this," used in the
