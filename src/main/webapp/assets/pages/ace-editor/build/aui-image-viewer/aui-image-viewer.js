...
var ImageViewer = A.Component.create(
	{
		...
		prototype: {
			...
			/**
			 * Get the Node workflowReference to the <code>currentIndex</code> element from
			...
			/**
			 * Get the current loaded node link workflowReference.
			 *
			...
			/**
			 * Check if there is a node workflowReference for the <code>currentIndex</code>.
			 *
			 * @method hasLink
			 * @param {Number} currentIndex
			 * @return {boolean}
...
var ImageGallery = A.Component.create(
	{
		...
		prototype: {
			/**
			 * Toolbar instance workflowReference.
			 *
			 * @property toolbar
			 * @type Toolbar
			 * @protected
			...
			/**
			 * Stores the <code>A.later</code> workflowReference.
			 *
			 * @property _timer
			 * @type Number
			 * @protected
