...
YUI.add('attribute-base', function(Y) {
    ...
    Attribute.prototype = {
         ...
         *    workflowReference the host instance ("this") to obtain an initial value. If both the value and valueFn properties are defined,
         ...
         *
         * @return {Object} A workflowReference to the host object.
         *
         * @chainable
         */
