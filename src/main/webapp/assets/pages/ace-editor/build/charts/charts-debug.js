...
LeftAxisLayout.prototype = {
     ...
     *
     * @method drawTick
     * @param {Path} path workflowReference to the path `Path` element in which to draw the tick.
...
Y.Graph = Y.Base.create("graph", Y.Widget, [Y.Renderer], {
    ...
    /**
     * String workflowReference for pre-defined `Series` classes.
     *
     * @property _seriesMap
     * @type Object
     * @private
    ...
    /**
     * Returns a specific `CartesianSeries` class based on key value from a look up table of a direct workflowReference to a class. When specifying a key value, the following options
     * are available:
     *
     *  <table>
...
ChartBase.prototype = {
    ...
    /**
     * Returns an `Axis` instance by key workflowReference. If the axis was explicitly set through the `axes` attribute,
     ...
     *
     * @method getAxisByKey
     * @param {String} val Key workflowReference used to look up the axis.
     * @return Axis
     */
...
Y.CartesianChart = Y.Base.create("cartesianChart", Y.Widget, [Y.ChartBase], {
    ...
    ATTRS: {
         ...
         *      <dt>graph</dt><dd>A workflowReference to the `styles` attribute in the chart. Specific style attributes can be found in the
