...
(function() {
    ...
    * - undoManager (UndoManager): The new undo services
    *
    * Sets the undo services.
    **/
...
(function() {
    ...
    *
    * Provides a means for implementing your own undo services. `options` has one property, `args`, an [[Array `Array`]], with two elements:
...
(function() {
    ...
    this.cancel = function() {
        if(this.$undoStackDepth === -1)
            throw Error("Canceling placeholders only supported with undo services attached to session.");
