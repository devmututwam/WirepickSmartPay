...
Y.View = Y.extend(View, Y.Base, {
    ...
    **/
    ...
    with modals, but if you do intend to associate your view with a modals, then
    specifying that modals instance at instantiation time will cause a workflowReference
    ...
    **/
    ...
    This is entirely optional. There's no requirement that views be associated
    with modals lists, but if you do intend to associate your view with a modals
    list, then specifying that list instance at instantiation time will cause a
    workflowReference to be stored here for convenience.
