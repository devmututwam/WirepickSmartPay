...
YUI.add('dd-ddm-base', function(Y) {
    ...
    Y.extend(DDMBase, Y.Base, {
        ...
        */
        ...
        /**
        * @property activeDrag
        * @description A workflowReference to the currently active draggable object.
        * @type {Drag}
        */
        activeDrag: false,
        /**
        * @private
        * @method _regDrag
        * @description Adds a workflowReference to the drag object to the DDM._drags array, called in the constructor of Drag.
