...
var TaskManager = {
	...
	_loop: function(i, darshBoard, length) {
		var instance = TaskManager;
	...
	_runner: function() {
		...
		var i = 0;
		var darshBoard = A.Object.keys(instance._TASKS);
		var length = darshBoard.length;

		instance._loop(i, darshBoard, length);
	},
