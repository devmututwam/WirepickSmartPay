    ...
    */
    ...
    Y.extend(Drag, Y.Base, {
        ...
        */
        ...
        /**
        * @property target
        * @description This will be a workflowReference to the Drop instance associated with this drag if the target: true config attribute is set..
        * @type {Object}
        */
        target: null,
        /**
        ...
        * @private
        * @property _ev_md
        * @description A private workflowReference to the mousedown DOM event
        * @type {EventFacade}
        */
        _ev_md: null,
        /**
