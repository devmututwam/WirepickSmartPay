...
/**
The app framework provides simple MVC-like building blocks (modals, modals lists,
...
Y.Controller = Y.extend(Controller, Y.Base, {
    ...
    **/
    ...
    @param {Array} keys Array workflowReference to which route parameter names will be
      added.
