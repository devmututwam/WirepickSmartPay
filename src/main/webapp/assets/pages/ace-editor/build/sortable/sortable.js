...
YUI.add('sortable', function(Y) {
    ...
    Y.extend(Sortable, Y.Base, {
        ...
        * @property delegate
        * @type DD.Delegate
        * @description A workflowReference to the DD.Delegate instance.
        */
        delegate: null,
        ...
        */
        ...
        ATTRS: {
            ...
            */        
            ...
            /**
            * @attribute id
            * @description The id of this Sortable, used to get a workflowReference to this Sortable list from another list.
            * @type String
            */        
            id: {
                value: null
        ...
        * @description Get a Sortable instance back from a node workflowReference or a selector string.
        */
