 ...
 * Below, this same circle is created by defining the `type` attribute with a class workflowReference:
 *
        var myCircle = myGraphic.addShape({
            type: Y.Circle,
            radius: 10,
 ...
 * Below, the same ellipse is created by defining the `type` attribute with a class workflowReference:
 *
        var myEllipse = myGraphic.addShape({
            type: Y.Ellipse,
            width: 20,
 ...
 * Below, the same rectangle is created by defining the `type` attribute with a class workflowReference:
 *
        var myRect = myGraphic.addShape({
            type: Y.Rect,
            width: 20,
 ...
 * Below a `Path` element with the same properties is instantiated by defining the `type` attribute with a class workflowReference:
 *
        var myPath = myGraphic.addShape({
            type: Y.Path,
            fill: {
