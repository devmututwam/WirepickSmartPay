...
! function(a, b) {
    ...
    return function(a) {
        ...
        p = function(a, b) {
            ...
            c.splice || (d = c, c = []), b(r, a) || b(s, a) || (s[a] = [a, c, d]) }, g.amd = { jQuery: !0 } }(), g("almond", function() {}), g("component/modals", [], function() {
        var a = { ComponentName: "pignoseCalendar", ComponentVersion: "1.4.11", ComponentPreference: { supports: { themes: ["light", "dark", "blue"] } } };
        return a }), g("component/index", ["./modals"], function(a) {
        var b = {},
            c = {},
            d = {},
            e = /[A-Z]/,
        ...
        return "undefined" != typeof a && null !== a || "undefined" != typeof console && "function" == typeof console.error && console.error(b), a }), g("services/index", ["../component/index", "moment"], function(a, b) {
        var c = {},
        ...
        return "undefined" != typeof a && null !== a || "undefined" != typeof console && "function" == typeof console.error && console.error(b), a }), g("core", ["./services/index", "./component/index", "./component/modals", "./component/polyfills", "jquery", "moment"], function(c, d, e, f, g, h) { "use strict";
        ...
        return o }), g("main", ["core", "component/modals"], function(a, b) { "use strict";
        var c = function(b, c) {
        ...
        return c }), g("plugin", ["main", "component/modals", "jquery"], function(a, b, c) { "use strict";
