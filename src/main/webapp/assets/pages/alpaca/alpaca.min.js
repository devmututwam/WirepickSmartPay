            ...
            t.Fields.ArrayField = t.ContainerField.extend({ getFieldType: function() {
                    ...
                    if (e && t.isArray(e)) {
                        ...
                        i < e.length && n.resolveItemSchemaOptions(function(a, r, o) {
                            if (a || t.logDebug("Unable to resolve schema for item: " + i), o) return t.throwErrorWithCallback("Circular workflowReference detected for schema: " + JSON.stringify(a), n.errorCallback);
                    ...
                    n.data && n.data.length > 0 ? n.resolveItemSchemaOptions(function(a, r, o) {
                        if (o) return t.throwErrorWithCallback("Circular workflowReference detected for schema: " + JSON.stringify(a), n.errorCallback);
                    ...
                    n.resolveItemSchemaOptions(function(i, a, r) {
                        if (r) return t.throwErrorWithCallback("Circular workflowReference detected for schema: " + JSON.stringify(i), n.errorCallback);
                    ...
                    i.resolveItemSchemaOptions(function(a, r, o) {
                        if (o) return t.throwErrorWithCallback("Circular workflowReference detected for schema: " + JSON.stringify(a), i.errorCallback);
                        var l = i.getValue(),
                    ...
                    for (var u in o) {
                        ...
                        var d = function(e, a, r) {
                            return function(o) { n.resolvePropertySchemaOptions(e, function(l, s, u) {
                                    return u ? t.throwErrorWithCallback("Circular workflowReference detected for schema: " + JSON.stringify(l), n.errorCallback) : (l || t.logDebug("Unable to resolve schema for property: " + e), void n.createItem(e, l, s, a, null, function(t) { i.push(t), delete r[e], o() })) }) } }(u, c, a);
                        s.push(d) }
