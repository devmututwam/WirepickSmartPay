...
$(document).ready(function() {
    ...
    const form = $("#revByRegionalManagerForm").show();
...
$(document).ready(function(){
    ...
    approveBtn.on('click', function () {
        swal({
            ...
            revByRegionalManagerFucntion(refNumber);
        });
    })

    //Saving function for the review
    function revByRegionalManagerFucntion(refNumber) {

        if ($('#revByRegionalManagerForm')[0].checkValidity()){
            var formData = new FormData($('#revByRegionalManagerForm')[0]);
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/saveRevByRegionalManager',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
            ...
            $('#revByRegionalManagerForm')[0].reportValidity();
        }
    }
    ...
    function sendBackFunction() {
        ...
        if ($('#revByRegionalManagerForm')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/sendBackByRegionalManager',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
