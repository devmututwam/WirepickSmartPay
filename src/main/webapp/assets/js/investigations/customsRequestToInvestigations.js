...
$(document).ready(function() {
    ...
    form.steps({
        ...
        onFinishing: function(event, currentIndex) {
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/saveRequestToInvestigations',
                data: dataString,
                dataType: 'json',
                cache: false,
                processData: false,
                ...
                success: function(response) {
                    ...
                    if (response["status"].toUpperCase() === "ERROR") {
                        ...
                        const applicationDate = response["applicationDate"];
                        // Show sweet alert
                        swal({
                            title: "Success",
                            text: "Request has been submitted successfully On "+applicationDate+".\n Reference Number:" + referenceNumber +" \n You can submit another Request .",
                            type: "success",
