...
$(document).ready(function() {
    ...
    const form = $("#revByDComOperationsForm").show();
...
$(document).ready(function(){
    ...
    approveBtn.on('click', function () {
        swal({
            ...
            revByDComOperationsFucntion(refNumber);
        });
    })

    //Saving function for the review
    function revByDComOperationsFucntion(refNumber) {

        if ($('#revByDComOperationsForm')[0].checkValidity()){
            var formData = new FormData($('#revByDComOperationsForm')[0]);
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/saveRevByDComOperations',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
            ...
            $('#revByDComOperationsForm')[0].reportValidity();
        }
    }
    ...
    function sendBackFunction() {
        ...
        if ($('#revByDComOperationsForm')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/sendBackByDComOperations',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
