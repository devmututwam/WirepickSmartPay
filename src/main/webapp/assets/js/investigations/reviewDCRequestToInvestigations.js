...
$(document).ready(function() {
    ...
    form.steps({
        ...
        onFinishing: function(event, currentIndex) {
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/reviewRequestToInvestigationsDC',
                data: dataString,
                dataType: 'json',
                cache: false,
                processData: false,
...
$(document).ready(function(){
    ...
    function sendBackFunction() {
        ...
        if ($('#businessOther')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/sendbackRequestToInvestigationsDC',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function rejectFunction() {
        ...
        if ($('#businessOther')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/rejectRequestToInvestigationsDC',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
