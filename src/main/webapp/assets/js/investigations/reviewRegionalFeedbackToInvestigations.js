...
$(document).ready(function() {
    ...
    form.steps({
        ...
        onFinishing: function(event, currentIndex) {
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/reviewFeedbackToInvestigationsRegional',
                data: dataString,
                dataType: 'json',
                cache: false,
                processData: false,
...
$(document).ready(function(){
    ...
    function sendBackFunction() {
        ...
        if ($('#captureCustomsAllegationForm')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/sendbackFeedbackToInvestigationsRegional',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function rejectFunction() {
        ...
        if ($('#captureCustomsAllegationForm')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/rejectFeedbackToInvestigationsRegional',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
