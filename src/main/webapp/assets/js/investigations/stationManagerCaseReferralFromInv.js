$(document).ready(function(){
    ...
    function sendBackFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/sendbackCaseReferralFromInvestigationsStation',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function approveFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/approveCaseReferralFromInvestigationsStation',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function rejectFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/rejectCaseReferralFromInvestigationsStation',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
