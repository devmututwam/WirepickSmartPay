...
$(document).ready(function() {
    ...
    form.steps({
        ...
        onFinishing: function(event, currentIndex) {
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/reviewRequestToInvestigationsStation',
                data: dataString,
                dataType: 'json',
                cache: false,
                processData: false,
...
$(document).ready(function(){
    ...
    function sendBackFunction() {
        ...
        if ($('#businessOther')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/sendbackRequestToInvestigationsStation',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function rejectFunction() {
        ...
        if ($('#businessOther')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/rejectRequestToInvestigationsStation',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
