$(document).ready(function(){
    ...
    function sendBackFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/sendbackCaseReferralFromInvestigationsDC',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function approveFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                // url: 'investigations/approveCaseReferralFromInvestigationsDC',
                url: 'investigations/assignCaseReferralToRegionalOrStationManagerDC',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function rejectFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/rejectCaseReferralFromInvestigationsDC',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
