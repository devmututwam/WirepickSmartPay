$(document).ready(function(){
    ...
    function sendBackFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/sendbackFeedbackFromInvestigationsOfficer',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function approveFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/approveFeedbackFromInvestigationsOfficer',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function rejectFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/rejectFeedbackFromInvestigationsOfficer',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
