...
$(document).ready(function() {
    ...
    const form = $("#revCustOfficerReqForInfoFromInvForm").show();
...
$(document).ready(function(){
    ...
    function revByExamOfficerFucntion(refNumber) {
        ...
        if ($('#revCustOfficerReqForInfoFromInvForm')[0].checkValidity()){
            var formData = new FormData($('#revCustOfficerReqForInfoFromInvForm')[0]);
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/saveRevCustOfficerReqForInfoFromInv',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
            ...
            $('#revCustOfficerReqForInfoFromInvForm')[0].reportValidity();
        }
    }
