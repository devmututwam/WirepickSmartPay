...
$(document).ready(function() {
    ...
    const form = $("#revRegMngrReqForInfoFromInvForm").show();
...
$(document).ready(function(){
    ...
    function revByExamOfficerFucntion(refNumber) {
        ...
        if ($('#revRegMngrReqForInfoFromInvForm')[0].checkValidity()){
            var formData = new FormData($('#revRegMngrReqForInfoFromInvForm')[0]);
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/saveRevRegMngrReqForInfoFromInv',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
            ...
            $('#revRegMngrReqForInfoFromInvForm')[0].reportValidity();
        }
    }
