...
$(document).ready(function() {
    ...
    const form = $("#revStnMngrReqForInfoFromInvForm").show();
...
$(document).ready(function(){
    ...
    function revByExamOfficerFucntion(refNumber) {
        ...
        if ($('#revStnMngrReqForInfoFromInvForm')[0].checkValidity()){
            var formData = new FormData($('#revStnMngrReqForInfoFromInvForm')[0]);
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/saveRevStnMngrReqForInfoFromInv',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
            ...
            $('#revStnMngrReqForInfoFromInvForm')[0].reportValidity();
        }
    }
