...
$(document).ready(function() {
    ...
    const form = $("#revComReqForInfoFromInvForm").show();
...
$(document).ready(function(){
    ...
    function revByExamOfficerFucntion(refNumber) {
        ...
        if ($('#revComReqForInfoFromInvForm')[0].checkValidity()){
            var formData = new FormData($('#revComReqForInfoFromInvForm')[0]);
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/saveReviewComReqForInfoFromInv',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
            ...
            $('#revComReqForInfoFromInvForm')[0].reportValidity();
        }
    }
