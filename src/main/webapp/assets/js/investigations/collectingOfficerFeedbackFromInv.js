$(document).ready(function(){
    ...
    sendback_btn.on('click', function () {
        swal({
            title : "Are you sure?",
            text : "You wish to SendBack This Feedback",
    ...
    function sendBackFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/sendbackFeedbackFromInvestigationsCollector',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    approve_btn.on('click', function () {
        swal({
            title : "Are you sure?",
            text : "You wish to Submit This Feedback",
            showCancelButton : true,
            confirmButtonClass : "btn-danger",
            confirmButtonText : "Yes",
            closeOnConfirm : false
    ...
    function approveFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/approveFeedbackFromInvestigationsCollector',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    reject_btn.on('click', function () {
        swal({
            title : "Are you sure?",
            text : "You want to Reject This Feedback",
            showCancelButton : true,
            confirmButtonClass : "btn-danger",
            confirmButtonText : "Yes",
            closeOnConfirm : false
    ...
    function rejectFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/rejectFeedbackFromInvestigationsCollector',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
