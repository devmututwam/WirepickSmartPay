$(document).ready(function(){
    ...
    function sendBackFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/sendbackFeedbackFromInvestigationsDC',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function approveFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/approveFeedbackFromInvestigationsDC',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function rejectFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/rejectFeedbackFromInvestigationsDC',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
