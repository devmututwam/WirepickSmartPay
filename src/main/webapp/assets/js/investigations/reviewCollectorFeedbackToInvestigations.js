...
$(document).ready(function() {
    ...
    form.steps({
        ...
        onFinishing: function(event, currentIndex) {
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/reviewFeedbackToInvestigationsCollector',
                data: dataString,
                dataType: 'json',
                cache: false,
                processData: false,
...
$(document).ready(function(){
    ...
    function sendBackFunction() {
        ...
        if ($('#captureCustomsAllegationForm')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/sendbackFeedbackToInvestigationsCollector',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function rejectFunction() {
        ...
        if ($('#captureCustomsAllegationForm')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/rejectFeedbackToInvestigationsCollector',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
