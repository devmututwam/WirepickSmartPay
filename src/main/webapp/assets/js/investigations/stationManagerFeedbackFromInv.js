$(document).ready(function(){
    ...
    function sendBackFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/sendbackFeedbackFromInvestigationsStation',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function approveFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/approveFeedbackFromInvestigationsStation',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
    ...
    function rejectFunction() {
        ...
        if ($('#station_form')[0].checkValidity()){
            ...
            $.ajax({
                type: 'POST',
                url: 'investigations/rejectFeedbackFromInvestigationsStation',
                data: formData,
                dataType: 'json',
                processData: false,
                contentType: false,
