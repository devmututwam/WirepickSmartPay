!function (t, e) {
    ...
    return function (t) {
        ...
        "use strict";
        n.r(e);
        var o = n(0), i = n.n(o), s = n(1), r = n.n(s), a = n(3), l = n.n(a), c = {
            props: {autoscroll: {type: Boolean, default: !0}}, watch: {
                ...
                maybeAdjustScroll: function () {
                    ...
                    if (e) {
                        var n = this.getDropdownViewport(), o = e.getBoundingClientRect(), i = o.top, s = o.bottom,
                            r = o.height;
        ...
        var _ = {
            components: m({}, d), mixins: [c, u, p], directives: {appendToBody: f}, props: {
                value: {},
                components: {
                ...
                return {uid: g(), search: "", open: !1, isComposing: !1, pushedTags: [], _value: []}
            }, watch: {
                ...
                setInternalValueFromOptions: function (t) {
                    ...
                    var e = this, n = [].concat(i()(this.options), i()(this.pushedTags)).filter((function (n) {
                ...
                isTrackingValues: function () {
                    ...
                    return {
                        ...
                        listHeader: e,
                        listFooter: e,
                        header: m({}, e, {deselect: this.deselect}),
                        footer: m({}, e, {deselect: this.deselect})
                    }
        ...
        }), [], !1, null, null, null).exports), w = {ajax: p, pointer: u, pointerScroll: c};
