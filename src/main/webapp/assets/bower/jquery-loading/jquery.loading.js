  ...
  $.extend(Loading.prototype, {
    ...
    createOverlay: function() {
      var l = `
                <br>
                <div>
                <div class="col-xl-2 col-md-4 col-sm-6 center-div-content">
      ...
      var overlay = $('<div class="loading-overlay loading-theme-' + this.settings.theme + '"><div class="loading-overlay-content">'
          + l + this.settings.message + '</div></div>')
