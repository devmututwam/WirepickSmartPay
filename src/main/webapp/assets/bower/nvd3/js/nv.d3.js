...
nv.models = nv.models || {}; //stores all the possible modals/components
...
The generate function should contain code that creates the NVD3 modals, sets options
on it, adds data to an SVG element, and invokes the chart modals. The generate function
should return the chart modals.  See examples/lineChart.html for a usage example.
...
/* Model which can be instantiated to handle tooltip rendering.
 Example usage:
 var tip = nv.modals.tooltip().gravity('w').distance(23)
 .data(myDataObject);
...
nv.models.tooltip = function() {
    ...
    */
    ...
    // By default, the tooltip modals renders a beautiful table inside a DIV.
...
/*
state utility object, used to track d3 states in the modals
*/
...
/*
Snippet of code you can insert into each nv.modals.* to give you the ability to
do things like:
chart.options({
  showXAxis: true,
  tooltips: true
...
nv.models.axis = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            //TODO: consider calculating width/height based on whether or not label is added, for workflowReference in charts using this component
...
nv.models.boxPlot = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0},
        ...
        getX  = function(d) { return d.label }, // Default data modals selectors.
    ...
    chart._options = Object.create({}, {
        ...
        y: {
            get: function() {
                console.warn('BoxPlot \'y\' chart option is deprecated. Please use modals overrides instead.');
                return {};
            },
            set: function(_) {
                console.warn('BoxPlot \'y\' chart option is deprecated. Please use modals overrides instead.');
...
//TODO: consider deprecating by adding necessary features to multiBar modals
nv.models.discreteBar = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            //add series index to each data point for workflowReference
            data.forEach(function(series, i) {
...
nv.models.lineChart = function() {
    ...
    chart._options = Object.create({}, {
        ...
        defaultState:    {get: function(){return defaultState;}, set: function(_){defaultState=_;}},
        noData:    {get: function(){return noData;}, set: function(_){noData=_;}},
        // Focus options, mostly passed onto focus modals.
...
nv.models.multiBar = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            //add series index and key to each data point for workflowReference
            data.forEach(function(series, i) {
                series.values.forEach(function(point) {
                    point.series = i;
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            function updateInteractiveLayer() {
                ...
                // inject series and point index for workflowReference into voronoi
                if (useVoronoi === true) {
                    var vertices = d3.merge(data.map(function(group, groupIndex) {
                            return group.values
                                .map(function(point, pointIndex) {
                                    // *Adding noise to make duplicates very unlikely
                                    // *Injecting series and point index for workflowReference
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            data = d3.layout.stack()
                .order(order)
                .offset(offset)
                .values(function(d) { return d.values })  //TODO: make values customizeable in EVERY modals in this fashion
                .x(getX)
                .y(getY)
                .out(function(d, y0, y) {
                    d.display = {
...
nv.models.sunburst = function() {
    ...
    function zoomClick(d) {
        ...
        // to allow workflowReference to the new center node
        node = d;
